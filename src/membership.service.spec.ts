...
describe("MembershipService getUsers() method", () => {
   ...
   */
  test("should call server and return search results", done => {
   ...
   */
  test("should throttle repeating requests until server replies", done => {
   ...
   * made to the server.
   */
  test("should send another request when called after resolved", done => {
   ...
   */
  test("should return only results that match the name query", done => {
    const name = "dave";
   ...
   */
  test("should call server once per query", done => {
    const phrase1 = "dave";
